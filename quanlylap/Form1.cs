...
namespace quanlylap
{
    public partial class Form1 : Form
    {
        ...
        static string sqlconnect = @"Data Source=123-PC\SQLEXPRESS;Initial Catalog=CuaHangLaptop;Integrated Security=True";

        private void Form1_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(sqlconnect);
            con.Open();
            String sql = "SELECT MaLT, TenLT, ThuongHieu, CauHinh, GiaBan, MoTa , TrangThai FROM Laptop";
            ...
            dataGridView1.Columns[6].HeaderText = "Trạng Thái";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand();
            command = con.CreateCommand();
            command.CommandText = "UPDATE Laptop SET Trangthai=0  WHERE MaLT = '" + malap + "'";
            int i = command.ExecuteNonQuery();
            if (i > 0)
            {
