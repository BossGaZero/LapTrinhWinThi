...
namespace WindowsFormsApplication22
{
    public partial class Form1 : Form
    {
        ...
        static string sqlconnect = @"Data Source=123-PC\SQLEXPRESS;Initial Catalog=QLThuChi;Integrated Security=True";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            String sql = "SELECT MaGiaoDich, Ngay, NoiDung, SoTien, Loai ,TrangThai FROM GiaoDich";
            ...
            dataGridView1.Columns[5].HeaderText = "Trạng Thái";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                SqlCommand command = new SqlCommand();
                command = con.CreateCommand();
                command.CommandText = "UPDATE GiaoDich SET TrangThai=0 WHERE MaGiaoDich = '" + magiaodich + "'";
                int i = command.ExecuteNonQuery();
                if (i > 0)
                {
