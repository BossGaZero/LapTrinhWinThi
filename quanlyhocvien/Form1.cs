...
namespace quanlyhocvien
{
    public partial class Form1 : Form
    {
        ...
        static string sqlconnect = @"Data Source=123-PC\SQLEXPRESS;Initial Catalog=QLHocSinhSinhVien;Integrated Security=True";

        private void Form1_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(sqlconnect);
            con.Open();
            String sql = "SELECT MSSV, Ho, Ten, Lop, NgaySinh, DiaChi , TrangThai FROM SinhVien";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand();
            command = con.CreateCommand();
            command.CommandText = "UPDATE Sinhvien SET TrangThai=0  WHERE MSSV = '"+mssv+"'";
            int i = command.ExecuteNonQuery();
            if (i > 0)
            {
