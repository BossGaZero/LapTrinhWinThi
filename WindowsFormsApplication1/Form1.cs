...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        static string sqlconnect = @"Data Source=123-PC\SQLEXPRESS;Initial Catalog=QLDuAn;Integrated Security=True";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            String sql = "SELECT MaDuAn, TenDuAn, NgayBatDau, NgayKetThuc,  HoanThanh ,TrangThai FROM DuAn";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
            {
                ...
                SqlCommand command = new SqlCommand();
                command = con.CreateCommand();
                command.CommandText = "UPDATE DUAN SET TrangThai=0 WHERE MaDuAn = '" + maduan + "'";
                int i = command.ExecuteNonQuery();
                if (i > 0)
                {
